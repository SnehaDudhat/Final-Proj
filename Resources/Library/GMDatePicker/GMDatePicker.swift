...
// Added Protocol for Date Picker
...
class GMDatePicker: UIView {
    ...
    struct Config {
        ...
        var confirmButtonFont: UIFont = UIFont.systemFont(ofSize: 16)
        var cancelButtonFont: UIFont = UIFont.systemFont(ofSize: 16)
    ...
    fileprivate func setup(_ parentVC: UIViewController) {
        ...
        confirmButton.titleLabel?.font = config.confirmButtonFont
        cancelButton.titleLabel?.font = config.cancelButtonFont
